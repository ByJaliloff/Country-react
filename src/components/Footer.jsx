function Footer() {
  return (
    <footer className="px-4 py-8 bg-white text-black dark:bg-[#2c2f48] dark:text-[#e0e0e0] transition-colors duration-300">
      <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
        <div className="flex flex-row pr-3 space-x-4 sm:space-x-8">
          <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full bg-violet-600 text-white dark:bg-violet-600">
          ...
          <ul className="flex flex-wrap items-center space-x-4 sm:space-x-8">
            <li>
              <a rel="noopener noreferrer" href="#">ByJaliloff</a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#">Privacy Policy ©2025</a>
            </li>
          </ul>
        </div>
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a rel="noopener noreferrer" href="#" title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-violet-600 text-white dark:bg-violet-600 dark:text-gray-50">
            ...
            <a rel="noopener noreferrer" href="#" title="Twitter"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
                <path
                  d="M31.937 6.093c-1.177 0.516-2.437 0.871-3.765 1.032 1.355-0.813 2.391-2.099 2.885-3.631-1.271 0.74-2.677 1.276-4.172 1.579-1.192-1.276-2.896-2.079-4.787-2.079-3.625 0-6.563 2.937-6.563 6.557 0 0.521 0.063 1.021 0.172 1.495-5.453-0.255-10.287-2.875-13.52-6.833-0.568 0.964-0.891 2.084-0.891 3.303 0 2.281 1.161 4.281 2.916 5.457-1.073-0.031-2.083-0.328-2.968-0.817v0.079c0 3.181 2.26 5.833 5.26 6.438-0.546 0.141-1.119 0.219-1.712 0.219-0.421 0-0.828-0.041-1.224-0.116 0.83 2.604 3.244 4.5 6.11 4.55-2.239 1.755-5.064 2.803-8.131 2.803-0.529 0-1.048-0.031-1.561-0.094 2.899 1.859 6.343 2.948 10.045 2.948 12.06 0 18.647-9.993 18.647-18.647 0-0.284-0.005-0.568-0.019-0.85 1.28-0.922 2.391-2.079 3.266-3.399z">
                </path>
              </svg>
            </a>
          </div>
